...
class MmsAdvancedMessageSegmentText(BaseModel):
    ...
    def from_json(cls, json_str: str) -> MmsAdvancedMessageSegmentText:
        """Create an instance of MmsAdvancedMessageSegmentText from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> MmsAdvancedMessageSegmentText:
        """Create an instance of MmsAdvancedMessageSegmentText from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MmsAdvancedMessageSegmentText.parse_obj(obj)

        _obj = MmsAdvancedMessageSegmentText.parse_obj(
            {"content_id": obj.get("contentId"), "text": obj.get("text")}
        )
        return _obj
