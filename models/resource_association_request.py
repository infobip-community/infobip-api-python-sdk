...
class ResourceAssociationRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceAssociationRequest:
        """Create an instance of ResourceAssociationRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceAssociationRequest:
        """Create an instance of ResourceAssociationRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ResourceAssociationRequest.parse_obj(obj)

        _obj = ResourceAssociationRequest.parse_obj(
            {
