...
class MmsAdvancedMessageSegmentBinary(BaseModel):
    ...
    def from_json(cls, json_str: str) -> MmsAdvancedMessageSegmentBinary:
        """Create an instance of MmsAdvancedMessageSegmentBinary from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> MmsAdvancedMessageSegmentBinary:
        """Create an instance of MmsAdvancedMessageSegmentBinary from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MmsAdvancedMessageSegmentBinary.parse_obj(obj)

        _obj = MmsAdvancedMessageSegmentBinary.parse_obj(
            {
