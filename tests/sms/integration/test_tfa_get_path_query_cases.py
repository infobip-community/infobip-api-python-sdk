...
from tests.sms.conftest import (
    get_get_tfa_verification_status_response,
    get_tfa_request_error_response,
)

ENDPOINT_TEST_ARGUMENTS = {
    "get_tfa_verification_status": {
        "endpoint": "/2fa/2/applications/1234567890/verifications",
        "http_method": "GET",
        "expected_headers": get_expected_get_headers(),
        "expected_path_parameters": {"appId": 1234567890},
        "expected_query_parameters": {"msisdn": "385717284759547"},
        "expected_json": None,
        "request_parameters": None,
        "method_name": "get_tfa_verification_status",
    },
}
...
@parametrize(
    ...
    responses=(
        [200, get_get_tfa_verification_status_response],
