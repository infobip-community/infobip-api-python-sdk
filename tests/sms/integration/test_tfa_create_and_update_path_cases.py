...
ENDPOINT_TEST_ARGUMENTS = {
    ...
    "create_tfa_message_template": {
        "endpoint": "/2fa/2/applications/1234567890/messages",
        "http_method": "POST",
        "expected_headers": get_expected_post_headers(),
        "expected_path_parameters": {"appId": 1234567890},
        "expected_query_parameters": None,
        "expected_json": GenerateCreateTFAMessageTemplateBodyFactoryIntegration,
        "request_parameters": get_create_tfa_message_template_body(),
        "method_name": "create_tfa_message_template",
    },
}
...
def case__supported_status(endpoint_type, responses):
    ...
    if endpoint_type == "update_tfa_application" and responses[0] == 200:
