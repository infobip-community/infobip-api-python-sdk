...
from tests.sms.conftest import (
    get_get_tfa_message_templates_response,
...
ENDPOINT_TEST_ARGUMENTS = {
    ...
    "get_tfa_message_templates": {
        "endpoint": "/2fa/2/applications/1234567890/messages",
        "http_method": "GET",
        "expected_headers": get_expected_get_headers(),
        "expected_path_parameters": {"appId": 1234567890},
        "expected_query_parameters": None,
        "expected_json": None,
        "request_parameters": None,
        "method_name": "get_tfa_message_templates",
    },
}
...
@parametrize(
    ...
    responses=(
        ...
        [200, get_get_tfa_message_templates_response],
...
def case__supported_status(endpoint_type, responses):
    ...
    if endpoint_type == "get_tfa_application" and responses[0] == 200:
        response_content = get_tfa_application_response
    if endpoint_type == "get_tfa_message_templates" and responses[0] == 200:
        response_content = get_get_tfa_message_templates_response
