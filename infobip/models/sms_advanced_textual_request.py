...
from infobip.models.sms_tracking import SmsTracking
from infobip.models.sms_url_options import SmsUrlOptions


class SendSMSRequestBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SendSMSRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SendSMSRequestBody:
        ...
        _obj = SendSMSRequestBody.parse_obj(
            {
