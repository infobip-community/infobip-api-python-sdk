...
class SmsDeliveryTimeFrom(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmsDeliveryTimeFrom:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SmsDeliveryTimeFrom:
        """Create an instance of SmsDeliveryTimeFrom from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SmsDeliveryTimeFrom.parse_obj(obj)

        _obj = SmsDeliveryTimeFrom.parse_obj(
