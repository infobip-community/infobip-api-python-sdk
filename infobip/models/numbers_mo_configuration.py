...
class NumbersMoConfiguration(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NumbersMoConfiguration:
        """Create an instance of NumbersMoConfiguration from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NumbersMoConfiguration:
        """Create an instance of NumbersMoConfiguration from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return NumbersMoConfiguration.parse_obj(obj)

        _obj = NumbersMoConfiguration.parse_obj(
            {
