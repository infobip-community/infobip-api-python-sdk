...
class NumberRegistrationNonProfitBrand(NumberRegistrationBrand):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NumberRegistrationNonProfitBrand:
        """Create an instance of NumberRegistrationNonProfitBrand from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NumberRegistrationNonProfitBrand:
        """Create an instance of NumberRegistrationNonProfitBrand from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return NumberRegistrationNonProfitBrand.parse_obj(obj)

        _obj = NumberRegistrationNonProfitBrand.parse_obj(
            {
                "id": obj.get("id"),
                "name": obj.get("name"),
