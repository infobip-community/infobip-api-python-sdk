...
class NumberRegistrationGovernmentBrand(NumberRegistrationBrand):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NumberRegistrationGovernmentBrand:
        """Create an instance of NumberRegistrationGovernmentBrand from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NumberRegistrationGovernmentBrand:
        """Create an instance of NumberRegistrationGovernmentBrand from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return NumberRegistrationGovernmentBrand.parse_obj(obj)

        _obj = NumberRegistrationGovernmentBrand.parse_obj(
            {
                "id": obj.get("id"),
                "name": obj.get("name"),
