...
class SmsReport(BaseModel):
    ...
    to: Optional[StrictStr] = Field(None, description="Message destination address.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SmsReport:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SmsReport:
        """Create an instance of SmsReport from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SmsReport.parse_obj(obj)

        _obj = SmsReport.parse_obj(
            {
